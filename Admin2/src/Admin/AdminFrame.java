...
public class AdminFrame extends JFrame {
	...
	public AdminFrame(AdminLogin parent,ObjectInputStream input,ObjectOutputStream output) throws Exception{
		...
		icon=new ImageIcon("C:\\Users\\ssiva\\Downloads\\osae\\osaeee\\ProjectImages2\\index.png");
		...
		icon2=new ImageIcon("C:\\Users\\ssiva\\Downloads\\osae\\osaeee\\ProjectImages2\\frame3.jpg");
		...
		icon4=new ImageIcon("C:\\Users\\ssiva\\Downloads\\osae\\osaeee\\ProjectImages2\\a1.jpg");
		...
		icon3=new ImageIcon("C:\\Users\\ssiva\\Downloads\\osae\\osaeee\\ProjectImages2\\logo.png");
		...
		lblAuctionBasket = new JLabel("Auctioner");
		lblAuctionBasket.setHorizontalAlignment(SwingConstants.CENTER);
		lblAuctionBasket.setForeground(Color.WHITE);
		...
		lblPvtltd = new JLabel("By Sathishkumar");
		lblPvtltd.setForeground(Color.WHITE);
		lblPvtltd.setBounds(858, 58, 100, 15);
